...
import org.lagrange.library.crypto.hash.SHA256
import org.lagrange.library.crypto.hash.HMACSHA256
...
class SHA256Test {
    ...
    fun testMillionA() {
        ...
        val millionA = ByteArray(1_000_000) { 'a'.toByte() }
    ...
    @Test
    fun testSingleByte() {
        val singleA = byteArrayOf('a'.toByte())
    ...
    fun testHMACLongKey() {
        ...
        val longKey = ByteArray(100) { 'K'.toByte() }
    ...
    fun testLargeInput() {
        ...
        val largeInput = ByteArray(10 * 1024 * 1024) { 'X'.toByte() }
